...
class ProductosTest < ApplicationSystemTestCase
  ...
  test "creating a Producto" do
    ...
    fill_in "Ancho", with: @producto.ancho
    fill_in "Ciudad", with: @producto.ciudad
    fill_in "Color", with: @producto.color
    fill_in "Descripcion", with: @producto.descripcion
    fill_in "Empresa", with: @producto.empresa
    fill_in "Material", with: @producto.material
    fill_in "Nombre", with: @producto.nombre
    fill_in "Peso", with: @producto.peso
    fill_in "Profundidad", with: @producto.profundidad
