...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { descripcion: @compra.descripcion, valor: @compra.valor } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { descripcion: @compra.descripcion, valor: @compra.valor } }
